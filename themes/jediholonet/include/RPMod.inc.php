...
define('FP_PHYSICAL_FITNESS', 18);
define('FP_FORCE_ATTUNEMENT', 19);
define('NUM_FORCE_POWERS_EXT', 20);
...
$GLOBALS['rpmod_config'] = array(
    ...
    'forcePowerNames'    => array (
        ...
        FP_PHYSICAL_FITNESS => 'Physical Endurance',
        FP_FORCE_ATTUNEMENT => 'Force Attunement',
    ),
    ...
    'defaultForcePowerCost' => array (
        ...
        FP_PHYSICAL_FITNESS => array( 2, 4, 6,  8, 10 ),    // Physical Fitness
        FP_FORCE_ATTUNEMENT => array( 2, 4, 6,  8, 10 ),    // Force Attunement
    ),
    ...
    'orderedPowers' => array (
        ...
        FP_SABERTHROW,          // Saber throw
        -1,                     // --- Space -----------------------------
        FP_PHYSICAL_FITNESS,    // Physical Fitness
        FP_FORCE_ATTUNEMENT,    // Force Attunement
    ),
